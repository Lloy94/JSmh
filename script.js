...
const gameElemets = document.getElementById("my_game").children

const title = gameElemets[0]
const userTask = gameElemets[1]
const userAnswer = gameElemets[2]
const btnGame = gameElemets[3]
